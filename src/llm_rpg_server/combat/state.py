...
class GameState(TypedDict):
    ...
    environment_context: Annotated[dict[str, Any], replace_state]
    combat_seed: Annotated[str, replace_state]
    ...
    player_race: Annotated[dict[str, Any] | None, replace_state]
    player_race_skills: Annotated[list[dict[str, Any]], replace_state]
    player_skills: Annotated[list[dict[str, Any]], replace_state]
    ...
    player_stamina: Annotated[int, replace_state]
    player_status: Annotated[str, replace_state]
    player_statuses: Annotated[list[dict[str, Any]], replace_state]
    player_traits: Annotated[list[str], replace_state]
    player_exposure: Annotated[dict[str, int], replace_state]
    player_stats: Annotated[dict[str, Any], replace_state]
    player_action: Annotated[dict[str, Any], replace_state]
    ai_class: Annotated[dict[str, Any] | None, replace_state]
    ai_race: Annotated[dict[str, Any] | None, replace_state]
    ai_race_skills: Annotated[list[dict[str, Any]], replace_state]
    ai_skills: Annotated[list[dict[str, Any]], replace_state]
    ...
    ai_stamina: Annotated[int, replace_state]
    ai_status: Annotated[str, replace_state]
    ai_statuses: Annotated[list[dict[str, Any]], replace_state]
    ai_traits: Annotated[list[str], replace_state]
    ai_exposure: Annotated[dict[str, int], replace_state]
    ai_stats: Annotated[dict[str, Any], replace_state]
    ai_action: Annotated[dict[str, Any], replace_state]
    last_resolution: Annotated[dict[str, Any], replace_state]
